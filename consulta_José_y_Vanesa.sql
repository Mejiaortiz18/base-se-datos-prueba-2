...
-- Base de datos: accommodations_tourism   <              _, 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-- Digitalizado a partir de capturas de pantalla de pgAdmin
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

-- Lo realizo José Enmanuel
...
VALUES (
    'Roberto', 'Magaña', 'Industris Diversas S.A. de C.V.',
    'robrtMaga@gmail.com', '708-101-4572x0265', 'M-45870216',
    'Paseo El Angel 17', NULL, 'San Salvador',
    'Ourense', 'El Salvador', '13164-7525',
    NOW(), NOW()
);
SELECT * FROM owners;
...
VALUES ('21', '10', '4', '16', 'Panoramic Getaway dan', 'espacio confortable',
    '4', '3', '2', '205.35', 'USD', '15:00:00', '12:00:00', 'F', '2026-04-17 01:23:25.356206',
    '2026-04-17 01:23:25.356206');


-- Lo realizo José Enmanuel
-- 3. Insertar Huésped y reserva
INSERT INTO booking_guests (booking_guest_id, booking_id, first_name, last_name, age,
    document_number, created_at)
VALUES ('104', '87', 'Daniel', 'Pérez',
...
VALUES ('101', '100', '8', NULL, '4', '2026-03-26', '2026-03-31', '3', '0', '817.49',
    '98.10', '5.08', '910.51', NULL, 'BK-OQ0IQ2R5', '2026-04-15 01:23:25.356206',
    '2026-04-15 01:23:25.356206', '2026-04-15 01:23:25.356206');


-- Lo realizo José Enmanuel
-- 5. SELECT Alojamientos activos. Filtrar activos
...
-- Lo realizo José Enmanuel
-- 6. SELECT Huéspedes por país. Filtrar por nacionalidad
SELECT * FROM public.guests
WHERE nationality = 'Irak'
...
SELECT * FROM public.guests
WHERE nationality = 'Iran'
ORDER BY guest_id ASC;


-- Lo realizo José Enmanuel
-- 7. SELECT Reservas por rango de fechas
SELECT booking_id, check_in_date, check_out_date FROM bookings
WHERE check_out_date BETWEEN '2026-03-03'
AND '2026-06-01';


-- Lo realizo José Enmanuel
-- 8. UPDATE Actualizar precio. Modificar precio
...
-- Lo realizo José Enmanuel
-- 9. UPDATE Estado reserva. Actualizar estado
...
INNER JOIN accommodation_types AS b ON a.accommodation_type_id = b.accommodation_type_id
...
SELECT
    a.accommodation_id,
    a.name              AS alojamiento,
    r.review_id,         -- NULL si no tiene reseña
    r.rating,             -- NULL si no tiene reseña
    r.review_title         -- NULL si no tiene reseña
FROM accommodations AS a
LEFT JOIN reviews AS r ON a.accommodation_id = r.accommodation_id
WHERE r.review_id IS NULL   -- solo los que NO tienen reseña
ORDER BY a.name ASC;
...
SELECT
    ...
    a.name                      AS alojamiento,
    a.base_price_per_night      AS precio_noche,
    b.booking_id                 -- NULL si no tiene reserva
FROM accommodations AS a
LEFT JOIN bookings AS b ON a.accommodation_id = b.accommodation_id
...
FROM accommodations AS a
INNER JOIN bookings AS b ON a.accommodation_id = b.accommodation_id
